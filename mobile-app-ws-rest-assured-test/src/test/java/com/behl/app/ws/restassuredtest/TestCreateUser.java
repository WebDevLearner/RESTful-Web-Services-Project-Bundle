...
class TestCreateUser {
	...
	final void testCreateUser() {
		...
		shippingAddress.put("city", "London");
		shippingAddress.put("country", "UK");
		shippingAddress.put("streetName", "My Street");
		shippingAddress.put("postalCode", "123456");
		shippingAddress.put("type", "shipping");
		
		Map<String, Object> billingAddress = new HashMap<>();
		billingAddress.put("city", "London");
		billingAddress.put("country", "UK");
		billingAddress.put("streetName", "My Street");
		...
		userDetails.put("firstName", "Arnav");
		userDetails.put("lastName", "Behl");
		userDetails.put("email", "behl_navneet@yahoo.com");
